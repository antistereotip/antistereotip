...
<table class="tbl-qa">
  <a class="ajax-action-links" href='add.php'>
		<img src="crud-icon/add.jpg" width="30" title="Add" style="padding-bottom: 20px"/></a>
  <tbody id="table-body">
  <?php
  if(!empty($result)) { 
  ...
  ?>
    ...
    <?php echo $row["post_title"]; ?></a><br/><a class="ajax-action-links" href='edit.php?id=<?php echo $row['id']; ?>'>
