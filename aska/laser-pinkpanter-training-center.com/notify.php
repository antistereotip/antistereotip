...
if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
	...
	Врати се на <a href='https://laser-pinkpanter-training-center.com/' style='color: #5fdab2;'>почетну страну</a></p>";
} else {
	echo "<p style='text-align: center; padding-top: 20%; font-size: 1.5em;'>
...
file_put_contents('../../secured/email2.txt', implode(' || ',$podaci)."\n",FILE_APPEND | LOCK_EX);
