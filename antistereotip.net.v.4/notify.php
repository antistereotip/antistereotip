...
if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
	...
	E-adresa ".$email." je validna. <br />Bićeš obavešten/a o novinama. Obaveštenja stižu šestomesečno i uvek se možeš odjaviti.<br /> 
	...
	Vrati se na <a href='https://antistereotip.net' style='color: #5fdab2;'>početnu stranu</a> i ukucaj validan format adrese.</p>";
	return 0;
}
